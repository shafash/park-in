...
<?php $MAKS=['motor'=>15000,'mobil'=>30000,'lainnya'=>60000]; $DENDA=['motor'=>3000,'mobil'=>5000,'lainnya'=>10000]; ?>
...
<div class="panel">
  ...
  <table class="tbl">
    ...
    <tr>
      ...
      <td class="fw7"><?php echo e($t->jenis_kendaraan === 'lainnya' ? 'Truk' : ucfirst($t->jenis_kendaraan)); ?></td>
      <td class="t-grn fw7"><?php echo e($t->rupiah); ?></td>
      <td class="t-gray">Rp. <?php echo e(number_format($MAKS[$t->jenis_kendaraan]??30000,0,',','.')); ?></td>
      <td class="t-ora fw7">Rp. <?php echo e(number_format($DENDA[$t->jenis_kendaraan]??5000,0,',','.')); ?></td>
      <td><span class="pill p-grn">Aktif</span></td>
      <td>
        <div class="tbl-acts">
          <button class="btn btn-out btn-xs" onclick="openEdit(<?php echo e($t->id_tarif); ?>,'<?php echo e($t->jenis_kendaraan); ?>',<?php echo e($t->tarif_per_jam); ?>)">Edit</button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\parkir_laravel\resources\views/admin/tarif.blade.php ENDPATH**/ ?>
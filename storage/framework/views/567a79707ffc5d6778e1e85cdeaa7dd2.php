...
<div class="panel">
  ...
  <table class="tbl">
    ...
    <tr>
      ...
      <td>
        <div class="tbl-acts">
          <button class="btn btn-out btn-xs" onclick="openEdit(<?php echo e($t->id_tarif); ?>,'<?php echo e($t->jenis_kendaraan); ?>',<?php echo e($t->tarif_per_jam); ?>,<?php echo e($t->denda_per_jam); ?>)">Edit</button>
